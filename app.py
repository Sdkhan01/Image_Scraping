...
def homepage():
        #redering index.html on homepage so that we can pass input through the form
...
def index():
    if request.method == 'POST':
                try:
                    ...
                    #2:here we are passing query through form, instead of giving data in hardcoded way
...
if __name__ == "__main__":
    app.run(host='0.0.0.0', port=8000) #Port cn be 5000 too.
